...
$CONFIG['options']['encodeURL'] = array(
   'title'   => 'Siteyi Sifrele',
   'desc'    => 'Site adresi þifrelenir böylece hangi siteye girdiðiniz bilinemez...',
   'default' => true,
   'force'   => false
);

$CONFIG['options']['encodePage'] = array(
   'title'   => 'Sayfayi Sifrele',
   'desc'    => 'Sayfanýn içerisindeki bütün resimler ve java kodlarý þifrelenir ama bu sitenin görünümünde deðiþikliðe sebep olabilir...',
   'default' => false,
   'force'   => false
);
...
$CONFIG['options']['allowCookies'] = array(
   'title'   => 'Kayitlara izin Ver',
   'desc'    => 'Oturum açmanýz gereken siteler dýþýnda bütün sitelerde kapatabilirsiniz...',
   'default' => true,
   'force'   => false
);
...
$CONFIG['options']['stripJS'] = array(
   'title'   => 'Scriptleri Kaldir',
   'desc'    => 'Gizliliði korumak ve sayfa yükünü azaltarak hýzlandýrmak için komut dosyalarý çýkartýlýr. Ancak, sitelerin görünümü deðiþip düz yazý olabilir bazý siteler buna imkan sunacaktýr. (Önerilen) (açýk olmasý)',
   'default' => true,
   'force'   => false
);

$CONFIG['options']['stripObjects'] = array(
   'title'   => 'Flashlari Kaldir',
   'desc'    => 'Flash, Java ve diðer nesneleri kaldýrarak sayfa yükleme sürelerini artýrabilirsiniz.',
   'default' => false,
   'force'   => false
);
