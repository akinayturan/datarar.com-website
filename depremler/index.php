...
<meta name="description" content="Son Depremler | Güncel Depremler | EPfarký | Birazcýk Farklý" />
<meta name="keywords" content="Son, güncel, Depremler, epfarki, ep, farki, evrensel, paylasim, evrenselpaylasim, farký, farklý, farkli, fark, " />

<title>Son Depremler | EPfarký</title>
...
<meta name="abstract" content="EPfarký » Birazcýk Farklý" />
<meta name="DC.title" content="EPfarký » Birazcýk Farklý!" />  
...
<?php 
// Server hata mesajlarýný kapatýyoruz
error_reporting(E_ALL);
ini_set('display_errors','Off');

// Bilgilerin alýnacaðý adresi tanýmlýyoruz
$sunucu = "http://www.koeri.boun.edu.tr/scripts/lst9.asp";

$gelen_sayfa = file_get_contents("$sunucu") or die('<b>HATA!</b><br> Sunucuya baðlanýlamadý!');
$basladi = stristr($gelen_sayfa,"<pre>");
$bitti = strpos($basladi,"</pre>");
$durum1 = substr($basladi,0,$bitti);
$depremler = "$durum1</pre>";

// Bilgileri ekrana yazdýrýyoruz
echo "
$depremler";
...
<p>
<a href="http://epfarki.com/">EPfarký</a> 
<a target="_blank" rel="nofollow" href="http://creativecommons.org/licenses/by-nc-nd/2.5/">© 2012</a> | Tasarým: <a href="http://epfarki.com/iletisim/">Bizimakin</a> | Özel Ýletiþim: epfarki [at] gmail.com
</p>
